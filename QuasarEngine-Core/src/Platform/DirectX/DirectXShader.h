...
namespace QuasarEngine
{
	...
	{
	public:
		DirectXShader(const ShaderDescription& desc);
	...
	private:
		...
		std::unique_ptr<DirectXUniformBuffer> m_GlobalUBO;
		std::unique_ptr<DirectXUniformBuffer> m_ObjectUBO;
		...
		DirectXTexture2D* defaultBlueTexture;
