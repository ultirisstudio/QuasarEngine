...
{
	PBRStaticTechnique::PBRStaticTechnique(SkyboxHDR* skybox)
		: m_Skybox(skybox)
	{
	...
	PBRStaticTechnique::~PBRStaticTechnique()
	{
		m_Shader.reset();
	}

	void PBRStaticTechnique::Begin(RenderContext& ctx)
	{
		m_Shader->Use();
	...
	void PBRStaticTechnique::Submit(RenderContext& ctx, RenderObject& obj)
	{
