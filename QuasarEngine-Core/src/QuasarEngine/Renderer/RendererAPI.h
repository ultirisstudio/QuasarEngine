...
virtual void DrawArraysInstanced(DrawMode drawMode, uint32_t size, uint32_t instanceCount) = 0;
virtual void DrawElements(DrawMode drawMode, uint32_t count, uint32_t firstIndex, int32_t baseVertex) = 0;
virtual void DrawElementsInstanced(DrawMode drawMode, uint32_t count, uint32_t instanceCount, uint32_t firstIndex, int32_t baseVertex) = 0;
