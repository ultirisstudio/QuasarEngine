...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          StyleColorsModernLight(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsModernDarkBis(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsModernDark(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsRealDark(ImGuiStyle* dst = NULL);
