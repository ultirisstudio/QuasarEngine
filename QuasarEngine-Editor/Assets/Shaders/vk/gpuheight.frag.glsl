...
layout(set = 1, binding = 4) uniform sampler2D roughness_texture;
layout(set = 1, binding = 5) uniform sampler2D metallic_texture;
layout(set = 1, binding = 6) uniform sampler2D ao_texture;
